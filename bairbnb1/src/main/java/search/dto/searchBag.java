...
public class searchBag {
	...
	public String toString() {
		return "searchBag [proid=" + proid + ", memid=" + memid + ", pronam=" + pronam + ", proadd=" + proadd
				+ ", protel=" + protel + ", propk=" + propk + ", prowifi=" + prowifi + ", propet=" + propet + ", probk="
				+ probk + ", proprice=" + proprice + ", proimg=" + proimg + "]";
	}
