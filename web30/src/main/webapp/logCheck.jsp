<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% // 스크립트릿: 자바 코드의 일부분
    	...
    	if (id.equals(id2) && pw.equals(pw2)) {
    		...
    		// 세션도 내장된 객체로 제공된다
    		// 내장된 객체: 미리 객체를 만들어서 제공되는 객체
    		// reqeust, response, sesstion, out, application
    		// 자바스크립트의 내장된 객체: location, window, document, history, console
    		// HttpSesstion session = new HttpSesstion();
...
<!-- id세션이 잡혀있다라는 것은(null이 아니라는 것) 로그인이 성공했다라는 의미로 해석 -->
